...
class DataTransformation:
    ...
    def get_data_transformer_object(self):
        """
        This function returns a ColumnTransformer object that applies different transformations
        ...
        try:
            ...
            logging.info("Numerical and categorical columns are transformed / encoded.")
    ...
    def initiate_data_transformation(self, train_path, test_path):
        try:
            ...
            logging.info("Applying preprocessing object on training dataframe and target feature.")
